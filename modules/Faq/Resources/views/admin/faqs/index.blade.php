...
@component('admin::components.page.header')
    @slot('title', trans('faq::admin.name'))

    <li class="active">{{ trans('faq::admin.name') }}</li>
@endcomponent

@component('admin::components.page.index_table')
    @slot('buttons', ['create'])
    @slot('resource', 'faq')
    @slot('name', trans('faq::admin.name'))
    ...
    @component('admin::components.table')
        @slot('thead')
            <tr>
                ...
                <th>{{ trans('faq::admin.tab_lists.table.title') }}</th>
                <th>{{ trans('faq::admin.tab_lists.table.publish_status') }}</th>
...
@push('scripts')
    <script type="module">
        new DataTable('#faq-table .table', {
            columns: [
                { data: 'checkbox', orderable: false, searchable: false, width: '3%' },
                { data: 'id', width: '5%' },
                { data: 'name', name: 'translations.name', class: 'name' },
