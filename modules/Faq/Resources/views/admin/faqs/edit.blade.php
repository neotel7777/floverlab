...
@component('admin::components.page.header')
    @slot('title', trans('admin::resource.edit', ['resource' => trans('faq::admin.name')]))
    @slot('subtitle', $faq->name)

    <li><a href="{{ route('admin.faq.index') }}">{{ trans('faq::admin.name') }}</a></li>
    <li class="active">{{ trans('admin::resource.edit', ['resource' => trans('faq::admin.name')]) }}</li>
@endcomponent
...
@push('globals')
    @vite([
        ...
        'modules/Faq/Resources/assets/admin/items/js/edit.js',
