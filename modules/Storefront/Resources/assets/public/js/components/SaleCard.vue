<template>
    <div class="product-card products-day__slide flex-row-start-center" >
        ...
        <div class="product-card_description gap-10 flex-column-start-start">
            <a class="product-card__name font-16-20-normal color-black" :href="productUrl" v-html="name"></a>
            <div class="product-card__delivery flex-row-start-center font-14-16-normal color-neutral gap-10" >
            ...
            <div class="product-card_price flex-column-start-start">
                <div class="product-card_old-price_block flex-row-start-end gap-10 " v-if="special_price">
                    <div class="product-card-mini__old-price font-14-16-normal color-ligth-grey" v-html="special_price_formated"></div>
                    <div class="product-card-mini__badge-discount font-14-16-normal color-white bk-color-dark-green" v-html="percent"></div>
                </div>
                <span class="font-24-26-normal color-black" v-html="price_formated">
                </span>
            </div>
        </div>
