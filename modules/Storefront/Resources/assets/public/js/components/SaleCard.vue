<template>
    <div class="product-card products-day__slide" :data-id="id" :data-price="item.formatted_price">
        <a class="product-card_imageWrap" :href="productUrl">
        ...
        <div class="product-card_description">
            ...
            <div class="product-card_price ">
                <div class="product-card_old-price_block">
                    <div class="product-card-mini__old-price" v-html="special_price_formated">MDL</div>
        ...
        <button type="button" class="product-card__favorite"
                ...
                @click="syncWishlist"
                aria-label="{{ trans('storefront::layout.add_in_favorites') }}">
